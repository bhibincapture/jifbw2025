    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li><?php echo $postcatDB["postcat_title"];?></li>
        </ol>
        <h2><?php echo $postcatDB["postcat_title"];?></h2>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
			...
			$idcat = $postcatDB["postcat_id"];
			$postQR = $db->conn -> query("SELECT * FROM `mdl_post` WHERE `post_status`='published' && `post_category` LIKE '%,$idcat,%' ORDER by `post_datemodify` DESC");
			while($postDB = $postQR -> fetch_assoc()){
              ...
              <article class='entry'>
                ...
                <div class='entry-content'>";
                  echo substr($postDB["post_content"], 0, 350)." ...";
				  echo "
                  <div class='read-more'>
                    <a href='".DB_LOCAL.DB_LINK."/post/".$postDB["post_slug"]."/'>Read More</a>
                  </div>
                </div>
              </article>";
			}?>
