...
<main id="main">
	<section class="breadcrumbs">
		<div class="container">
			...
			<h1>Exhibitor <?php echo $usercatDB["usercat_title"];?></h1>
		</div>
    </section>
    <section id="blog" class="blog">
					...
					<div class="col-12 col-lg-6 entries">
					  <form method="get" action="<?php echo DB_LOCAL.DB_LINK."/search/";?>">
						<div class="input-group input-group-sm">
						  <input type="text" class="form-control" name="q" placeholder="Search Exhibitor...." required>
        ...
        <div class="container">
			<div class="row">
			  ...
			  $userQR = $db->conn -> query("SELECT * FROM `mdl_user` WHERE `user_category`='".$usercatDB["usercat_id"]."' && `user_status`='published' ORDER BY RAND() ");
