      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-12 entries">
		    <article class="entry">
			  <h2 class="entry-title mb-3">13 Best Hotels Recomended in Jepara</h2>
			  <div class="row">
			    <div class="col-4 col-lg-4 p-1">
                  <a href="<?php echo DB_LOCAL.DB_LINK;?>/mdl-content/themes/jifbw2025/assets/img/hotels/IMG_7303.jpg" data-gallery="deseasonBeachHotel" class="portfokio-lightbox" title="Hotel d'Season Premiere Jepara">
                    <img src="<?php echo DB_LOCAL.DB_LINK;?>/mdl-content/themes/jifbw2025/assets/img/hotels/IMG_7303.jpg" alt="Hotel d'Season Premiere Jepara" class="img-fluid">
                  </a>
                </div>
			    <div class="col-4 col-lg-4 p-1">
                  <a href="<?php echo DB_LOCAL.DB_LINK;?>/mdl-content/themes/jifbw2025/assets/img/hotels/IMG_3471-scaled.jpg" data-gallery="deseasonBeachHotel" class="portfokio-lightbox" title="Hotel d'Season Premiere Jepara">
                    <img src="<?php echo DB_LOCAL.DB_LINK;?>/mdl-content/themes/jifbw2025/assets/img/hotels/IMG_3471-scaled.jpg" alt="Hotel d'Season Premiere Jepara" class="img-fluid">
                  </a>
                </div>
			    <div class="col-4 col-lg-4 p-1">
                  <a href="<?php echo DB_LOCAL.DB_LINK;?>/mdl-content/themes/jifbw2025/assets/img/hotels/resto.jpg" data-gallery="deseasonBeachHotel" class="portfokio-lightbox" title="Hotel d'Season Premiere Jepara">
                    <img src="<?php echo DB_LOCAL.DB_LINK;?>/mdl-content/themes/jifbw2025/assets/img/hotels/resto.jpg" alt="Hotel d'Season Premiere Jepara" class="img-fluid">
                  </a>
                </div>
			    <div class="col-12 col-lg-12 mb-4 mt-2">
				  <h3 class="entry-title">1. Hotel d'Season Premiere Jepara</h3>
				  ...
				  <p><i class="far fa-envelope"></i> <b>Email</b> : fo@dseasonjepara.com</p>
				  <p><i class="fas fa-globe"></i> <b>Website</b> : <a href="https://dseasonjepara.com/" title="Hotel d'Season Premiere Jepara" target="_blank">dseasonjepara.com</a></p>
				  <p><i class="fas fa-share-square"></i> <b>Go to Location</b> : <a href="https://g.co/kgs/2MueKrK" title="Hotel d'Season Premiere Jepara" target="_blank">https://g.co/kgs/2MueKrK</a></p>
                </div>
			    ...
			    <div class="col-12 col-lg-12 mb-4 mt-2">
				  <h3 class="entry-title">2. Tilem Beach Hotel and Resort</h3>
				  <p style="color: #ffc107"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></p>
			    ...
			    <div class="col-12 col-lg-8 mb-4 mt-2">
				  <h3 class="entry-title">3. Syailendra Hotel</h3>
				  <p style="color: #ffc107"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></p>
			    ...
			    <div class="col-8 col-lg-8 mb-4 mt-4">
				  <h3 class="entry-title">4. Villa Suerte</h3>
				  <p style="color: #ffc107"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></p>
			    ...
			    <div class="col-8 col-lg-8 mb-4 mt-4">
				  <h3 class="entry-title">5. Jepara Garden Resort</h3>
				  <p style="color: #ffc107"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></p>
			    ...
			    <div class="col-8 col-lg-8 mb-4 mt-4">
				  <h3 class="entry-title">6. Ocean View Residence</h3>
				  <p style="color: #ffc107"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></p>
			    ...
			    <div class="col-8 col-lg-8 mb-4 mt-4">
				  <h3 class="entry-title">7. Belaya Hotel</h3>
				  <p style="color: #ffc107"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></p>
