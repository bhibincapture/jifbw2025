...
if($numpermalink == $default + 1){
  if($permalink[$i+1] == "visitors" || $permalink[$i+1] == "users" || $permalink[$i+1] == "convert"){
...
?> 
  ...
  <footer id="footer" class="footer">
        ...
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <div class="social-links mt-3">
              <a href="https://instagram.com/jifbw/" class="instagram" title="IG @JIFBW" target="_blank"><i class="bi bi-instagram"></i></a>
              <a href="https://www.facebook.com/jifbw/" class="facebook" title="FB @JIFBW" target="_blank"><i class="bi bi-facebook"></i></a>
              <a href="https://www.youtube.com/@jifbw/" class="youtube" title="YT @JIFBW" target="_blank"><i class="bi bi-youtube"></i></a>
              <a href="https://www.tiktok.com/@jifbw/" class="youtube" title="TT @JIFBW" target="_blank"><i class="bi bi-titok"></i></a>
          ...
          <div class="col-lg-2 col-6 footer-links">
            <h4>Buyers Menu</h4>
            <ul>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/sign-up/";?>" title="Sign Up">Sign Up</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/login/";?>" title="Log In">Log In</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/contact-us/";?>" title="Contact Us">Contact Us</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/contact-us/";?>" title="Plan a Visit">Plan a Visit</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/why-visit-us/";?>" title="Why Visit Us ?">Why Visit Us ?</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/terms/";?>" title="Terms & Conditions">Terms & Conditions</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/hotels/";?>" title="Hotels">Hotels</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/travels/";?>" title="Travels">Travels</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/register/";?>" title="Register">Register</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/login/";?>" title="Login">Log In</a></li>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="<?php echo DB_LOCAL.DB_LINK."/page/packages/";?>" title="Packages & Price">Packages & Price</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="https://blog.jifbw.com" title="Blog">Blog</a></li>
            </ul>
          </div>
    ...
    <div class="container">
      <div class="copyright">
        2023 - <?php echo date("Y");?> &copy; Copyright <a href="<?php echo DB_LOCAL.DB_LINK."/";?>" title="JIF-BW" style="color:#fff;"><strong>JIFBW</span></strong></a>. All Rights Reserved<br/>
		<a href="https://www.bhibin.com" title="Web Development" target="_blank">Web Development</a> By Bhibin
      </div>
      <!--<div class="credits">Developer by Bhibin</div>-->
    </div>
  </footer><!-- End Footer -->
    ...
    $(function () {
      ...
      var visitorsChart = new Chart($visitorsChart, {
        data: {
    	  ...
    	  $begin     = $today->sub(new DateInterval('P70D')); //created 30 days interval back
    	  $end       = new DateTime();
